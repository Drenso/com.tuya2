...
CONTRIBUTE
Tuya makes many devices, and we're working together with the Homey Community to add support for all of them. If you are missing support for a device, shoot us an email and include the device specification from the device settings.
